...
export class ObjectInfo {
  ...
  /** Byte offset of the bytesStart field within the SerializedFile (for metadata rebuild). */
  _bytesStartFieldOffset = 0;
  /** Byte offset of the bytesSize field within the SerializedFile (for metadata rebuild). */
  _bytesSizeFieldOffset = 0;
  /** Modified object data (set by external code to trigger metadata rebuild). */
  _modifiedData?: ArrayBuffer;
